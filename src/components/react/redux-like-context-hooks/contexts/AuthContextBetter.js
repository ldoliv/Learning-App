...
import {createActions, useReducerMap} from './redux-helpers';
...
const authActions = createActions(reducerMap);
...
function AuthProvider(props) {
	...
	const [auth, dispatch] = useReducerMap(reducerMap, initialState);
